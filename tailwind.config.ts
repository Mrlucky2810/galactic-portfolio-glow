  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "neon-purple": "rgb(199 125 255)",
        "neon-pink": "rgb(255 60 172)",
        "neon-lime": "rgb(0 255 171)",
        "neon-orange": "rgb(255 159 67)",
        "neon-yellow": "rgb(255 235 59)",
        "neon-green": "rgb(76 255 76)",
        "neon-blue": "rgb(64 169 255)",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px rgb(0 229 255 / 0.3)" },
          "50%": { boxShadow: "0 0 40px rgb(0 229 255 / 0.8)" }
        }
      },
      animation: {
